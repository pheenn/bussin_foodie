 ...
 * Login View
 * 
 * Displays the login form with proper URLs using the base path
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Login - Bussin Foodie</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="login-container">
        ...
        <div class="links">
            <p>Don't have an account? <a href="<?php echo htmlspecialchars(url('register')); ?>">Register here</a></p>
        </div>
    </div>
</body>
</html>
