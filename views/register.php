 ...
 * Register View
 * 
 * Displays the registration form with proper URLs using the base path
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Register - Bussin Foodie</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="register-container">
        ...
        <div class="links">
            <p>Already have an account? <a href="<?php echo htmlspecialchars(url('login')); ?>">Login here</a></p>
        </div>
    </div>
</body>
</html>
